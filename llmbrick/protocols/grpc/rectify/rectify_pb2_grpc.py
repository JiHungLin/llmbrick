...
from llmbrick.protocols.grpc.rectify import rectify_pb2 as protocols_dot_grpc_dot_rectify_dot_rectify__pb2
...
def add_RectifyServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('protocols.grpc.rectify.RectifyService', rpc_method_handlers)
