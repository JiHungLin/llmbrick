...
from llmbrick.protocols.grpc.rectify import (
    rectify_pb2 as protocols_dot_grpc_dot_rectify_dot_rectify__pb2,
)
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f" but the generated code in protocols/grpc/rectify/rectify_pb2_grpc.py depends on"
...
class RectifyServiceStub(object):
    """Rectify 服務"""
...
class RectifyServiceServicer(object):
    """Rectify 服務"""
...
def add_RectifyServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "protocols.grpc.rectify.RectifyService", rpc_method_handlers
    )
