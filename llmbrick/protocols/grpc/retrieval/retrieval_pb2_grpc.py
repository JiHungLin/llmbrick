...
from llmbrick.protocols.grpc.retrieval import (
    retrieval_pb2 as protocols_dot_grpc_dot_retrieval_dot_retrieval__pb2,
)
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f" but the generated code in protocols/grpc/retrieval/retrieval_pb2_grpc.py depends on"
...
def add_RetrievalServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "protocols.grpc.retrieval.RetrievalService", rpc_method_handlers
    )
