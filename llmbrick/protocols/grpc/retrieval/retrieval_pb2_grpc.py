...
from llmbrick.protocols.grpc.retrieval import retrieval_pb2 as protocols_dot_grpc_dot_retrieval_dot_retrieval__pb2
...
def add_RetrievalServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('protocols.grpc.retrieval.RetrievalService', rpc_method_handlers)
