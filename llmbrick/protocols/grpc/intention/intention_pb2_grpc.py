...
from llmbrick.protocols.grpc.intention import intention_pb2 as protocols_dot_grpc_dot_intention_dot_intention__pb2
...
def add_IntentionServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('protocols.grpc.intention.IntentionService', rpc_method_handlers)
